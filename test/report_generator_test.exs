defmodule ReportsGeneratorTest do
  ...
  describe "fetch_higher_cost/2" do
    ...
    test "when the option is 'foods', return the food that apears the most" do
      file_name = "report_test.csv"
    ...
    test "when the option is invalid, return error message" do
      file_name = "report_test.csv"

      response =
        file_name
        |> ReportsGenerator.build()
        |> ReportsGenerator.fetch_higher_cost("fossssods")
